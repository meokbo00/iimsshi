...
public class ChBallControl : MonoBehaviour
{
    ...
    void Update()
    {
        if (!hasBeenLaunched && !challengeGameManager.isDragging)
        {
            LaunchBall();
        }
    ...
    void LaunchBall()
    {
        Vector2 launchForce = ChallengeGameManager.shotDirection * (ChallengeGameManager.shotDistance * 1.4f);
